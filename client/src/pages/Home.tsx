      ...
      <section className="grain relative flex min-h-[720px] items-end overflow-hidden bg-ink text-white md:min-h-[820px]">
        ...
        <div className="container relative z-10 pb-14 pt-36 md:pb-20">
          <div className="max-w-4xl animate-rise">
            ...
            <div className="mt-10 grid max-w-3xl gap-4 border-t border-white/20 pt-5 sm:grid-cols-3"><div><p className="font-mono text-[9px] uppercase tracking-[.2em] text-saffron-light">What</p><p className="mt-2 text-xs leading-5 text-white/75">AI-powered discovery of lesser-known Indian destinations.</p></div><div><p className="font-mono text-[9px] uppercase tracking-[.2em] text-saffron-light">Why</p><p className="mt-2 text-xs leading-5 text-white/75">Tourism is concentrated around the usual highlights.</p></div><div><p className="font-mono text-[9px] uppercase tracking-[.2em] text-saffron-light">How</p><p className="mt-2 text-xs leading-5 text-white/75">Community intelligence, a trust layer and a personal route.</p></div></div>
          </div>
